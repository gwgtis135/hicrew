...
.tablepress-id-1, .tablepress-id-1 tr, .tablepress-id-1 tbody td,
...
.tablepress-id-2, .tablepress-id-2 tr, .tablepress-id-2 tbody td,
	.tablepress-id-2 thead th, .tablepress-id-2 tfoot th {
	border: 1px solid #ddd;
	background-color: #fff;
	color: #333;
	vertical-align: middle;
...
.tablepress-id-2 .row-2 .column-2, .tablepress-id-2 .row-3 .column-2 {
	text-align: left
}

.tablepress-id-3, .tablepress-id-3 tr, .tablepress-id-3 tbody td,
...
<link rel="canonical" href="http://www.forwiz.com/business-results/business-results/" />
<link rel='shortlink' href='http://www.forwiz.com/?p=53' />
<link rel="alternate" type="application/json+oembed" href="http://www.forwiz.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.forwiz.com%2Fbusiness-results%2Fbusiness-results%2F" />
<link rel="alternate" type="text/xml+oembed" href="http://www.forwiz.com/wp-json/oembed/1.0/embed?url=http%3A%2F%2Fwww.forwiz.com%2Fbusiness-results%2Fbusiness-results%2F&#038;format=xml" />
<script type="text/javascript">
...
<!--[if lt IE 9]><script src="http://www.forwiz.com/wp-content/themes/enfold/js/html5shiv.js"></script><![endif]-->
<script type="text/javascript" src="http://openapi.map.naver.com/openapi/naverMap.naver?ver=2.0&key=_SUb5WoGnc"></script>
...
<div id='after_section_1' class='main_color container_wrap fullsize'>
				<div class='container'>
					<div class='template-page content  av-content-full alpha units'>
						<div class='post-entry post-entry-type-page post-entry-53'>
							<div class='entry-content-wrapper clearfix'>
								...
								<div class="togglecontainer toggle_close_all  avia-builder-el-11  el_after_av_hr  el_before_av_hr  ">
										...
										<div class="single_toggle" data-tags="{All} ">
											...
											<div id="toggle-id-1-container" class="toggle_wrap active_tc">
												<div class="toggle_content invers-color" itemprop="text">
													<ul>
														<li>2022.03  :  세종시 2021~2022년도 나이스 구축사업 </li>
													</ul>
												</div>
											</div>
										</div>
									...
									<section class="av_toggle_section" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
										<div class="single_toggle" data-tags="{All} ">
											<p data-fake-id="#toggle-id-2" class="toggler " itemprop="headline">
												2021<span class="toggle_icon"> <span class="vert_icon"></span><span class="hor_icon"></span></span>
											</p>
											<div id="toggle-id-2-container" class="toggle_wrap ">
												<div class="toggle_content invers-color" itemprop="text">
													<ul>
														<li>2021.08  :  세종시 2021~2022년도 나이스 구축사업 </li>
														<li>2021.01  :  대구 나이스 정보공시 유지보수 사업</li>
													</ul>
												</div>
											</div>
										</div>
									...
									<section class="av_toggle_section" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
										<div class="single_toggle" data-tags="{All} ">
											...
											<div id="toggle-id-3-container" class="toggle_wrap ">
												<div class="toggle_content invers-color" itemprop="text">
													<ul>
														<li>2020.12  :  대구 나이스 유지보수 사업</li>
														<li>2020.07  :  진천 나이스 유지보수 사업</li>
													</ul>
												</div>
											</div>
										</div>
									...
									<section class="av_toggle_section" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
										<div class="single_toggle" data-tags="{All} ">
											<p data-fake-id="#toggle-id-4" class="toggler " itemprop="headline">
												2019<span class="toggle_icon"> <span class="vert_icon"></span><span class="hor_icon"></span></span>
											</p>
											<div id="toggle-id-4-container" class="toggle_wrap ">
												<div class="toggle_content invers-color" itemprop="text">
													<ul>
														<li>2019.12  : 사립유치원 구축 사업</li>
													</ul>
												</div>
											</div>
										</div>
									...
									<section class="av_toggle_section" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
										<div class="single_toggle" data-tags="{All} ">
											<p data-fake-id="#toggle-id-5" class="toggler " itemprop="headline">
												2018<span class="toggle_icon"> <span class="vert_icon"></span><span class="hor_icon"></span></span>
											</p>
											<div id="toggle-id-5-container" class="toggle_wrap ">
												<div class="toggle_content invers-color" itemprop="text">
													<ul>
														<li>2018.03  :  하이크루 설립</li>
													</ul>
												</div>
											</div>
										</div>
								...
								<div style='height: 50px' class='hr hr-invisible  avia-builder-el-12  el_after_av_toggle_container  avia-builder-el-last '>
