...
<body onload="initialize()">
	...
	<div class="gtco-loader"></div>
					...
					<div class="col-xs-10 text-right menu-1 main-nav">
						<ul>
							...
							<li class="menu"><a href="#" data-nav-section="services">회사소개</a>
								<ul class="hide">
									<li><a href="#" onclick="movePage('ch.do')"
										data-nav-section="#companyHistory">연혁</a>
									<li><a href="chManage.do">연혁 관리</a>
									<li><a href="#" onclick="movePage('orgcht.do')">조직도</a>
									<li><a href="#" onClick="movePage('orgchtManage.do')">조직도 관리</a>
								</ul></li>
		...
		<div class="gtco-section-overflow">
			...
			<div class="gtco-section" id="gtco-services"
				...
				<div class="gtco-section" id="gtco-portfolio" data-section="CI">
					<div class="gtco-container">
						...
						<div class="row2">
							<a href="images/CI_PNG.zip"> <img
								src="images/btn_img_down.png" alt="PNG 다운로드" class="">
							</a> <a href="images/CI_AI.zip"> <img
								src="images/btn_ai_down.png" alt="AI 다운로드" class="">
							</a>
						</div>
					</div>
				</div>

				<div class="gtco-section" id="gtco-portfolio"
				...
				<div id="gtco-blog" data-section="blog">
					<div class="gtco-container">
						...
						<div class="row">
							<div class="col-md-4">
								<a href="http://hicrew.iptime.org:8888/"
									...
									<div class="gtco-text text-left">
										<h2>학생수강신청</h2>
										<p>언제,어디서나,인터넷만 되면 자유롭게 수강신청의 편의성을 제공하고, 체계적인 관리를 통해 효율성을
											증대 시키는 '수강신청 프로그램'</p>
							...
							<div class="col-md-4">
								<a
									href="http://www.forwiz.com/business-area/solution/withlearn/"
									class="gtco-card-item has-text">
									<figure>
										<div class="overlay">
											<i class="ti-plus"></i>
							...
							<div class="col-md-4">
								<a href="http://www.tobesoft.co.kr/product/Miplatform.do"
									...
									<div class="gtco-text text-left">
										...
										<p>강력하고 풍부한 데스크톱 수준의 사용자 인터페이스(UI) 및 용이한 애플리케이션 개발 환경을
											제공하고, 한번의 응용 프로그램 개발로 웹은 물론 윈도우 모바일 계열의 PDA, 스마트폰 등 다양한 채널을
											통합관리 할 수 있습니다.</p>
										<!-- <p class="gtco-category">Sep. 25th, 2016 by John Doe</p> -->
									</div>
								</a>
							...
							<div class="col-md-4">
								<a href="http://www.tobesoft.co.kr/product/Nexacro17.do"
									...
									<div class="gtco-text text-left">
										...
										<p>현재는 탁월한 고객 경험이 기업 가치를 결정합니다. 사용자 중심의 IT 환경 구축을 실현해 줄
											유일한 Real OSMU 솔루션! 웹과 네이티브의 경계를 허물고 하나의 소스로 모든 비즈니스 환경에 완벽하게
											대응할 수 있습니다.</p>
										<!-- <p class="gtco-category">Sep. 25th, 2016 by John Doe</p> -->
									</div>
								</a>
					...
					<div class="gtco-container">
						...
						<div class="row">
							<div class="owl-carousel owl-carousel-carousel">
								<div class="item">
									<img src="images/Crews/story4_1.jpg" witdh="345px"
										height="460px" alt="2019 종무식, 영덕">
								</div>
								<div class="item">
									<img src="images/Crews/story1_1.jpg" witdh="345px"
										height="460px" alt="거제, 바람의 언덕">
								</div>
								<div class="item">
									<img src="images/Crews/story2_1.jpg" witdh="345px"
										height="460px" alt="팔공, 동화사">
								</div>
								<div class="item">
									<img src="images/Crews/story3_1.jpg" witdh="345px"
										height="460px" alt="지리산, 화엄사">
								</div>
							</div>
						</div>
					</div>
