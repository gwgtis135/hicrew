									...
									<table>
										...
										<tbody>
											<tr class="notice">
												...
												<td>메뉴 순서 <input type="text" size="5" value="1" style="text-align:center;"></td>
											</tr>
											<tr class="notice">
												<td class="num"><input type="checkbox"></td>
												<td>메뉴 이름 <input type="text" size="50" value="회사 소개"></td>
												<td>메뉴 링크 <input type="text" size="50" value="cmpnyintrcn"></td>
												<td>메뉴 순서 <input type="text" size="5" value="2" style="text-align:center;"></td>
											</tr>
											<tr class="notice">
												<td class="num"><input type="checkbox"></td>
												<td>메뉴 이름 <input type="text" size="50" value="주요 사업"></td>
												<td>메뉴 링크 <input type="text" size="50" value="mainbsns"></td>
												<td>메뉴 순서 <input type="text" size="5" value="3" style="text-align:center;"></td>
											</tr>
											<tr class="notice">
												<td class="num"><input type="checkbox"></td>
												<td>메뉴 이름 <input type="text" size="50" value="그룹웨어"></td>
												<td>메뉴 링크 <input type="text" size="50" value="http://gw.hicrew.kr"></td>
												<td>메뉴 순서 <input type="text" size="5" value="4" style="text-align:center;"></td>
											</tr>
											<tr class="notice">
												<td class="num"><input type="checkbox"></td>
												<td>메뉴 이름 <input type="text" size="50" value="페이지 관리"></td>
												<td>메뉴 링크 <input type="text" size="50" value="adminPage"></td>
												<td>메뉴 순서 <input type="text" size="5" value="5" style="text-align:center;"></td>
											</tr>
										</tbody>
									</table>
								</div>
